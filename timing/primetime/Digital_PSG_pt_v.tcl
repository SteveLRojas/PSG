...
set_load -pin_load 10 [get_ports { ch0_audio[0] } ]
set_load -pin_load 10 [get_ports { ch0_audio[1] } ]
set_load -pin_load 10 [get_ports { ch0_audio[2] } ]
set_load -pin_load 10 [get_ports { ch0_audio[3] } ]
set_load -pin_load 10 [get_ports { ch1_audio[0] } ]
set_load -pin_load 10 [get_ports { ch1_audio[1] } ]
set_load -pin_load 10 [get_ports { ch1_audio[2] } ]
set_load -pin_load 10 [get_ports { ch1_audio[3] } ]
set_load -pin_load 10 [get_ports { ch2_audio[0] } ]
set_load -pin_load 10 [get_ports { ch2_audio[1] } ]
set_load -pin_load 10 [get_ports { ch2_audio[2] } ]
set_load -pin_load 10 [get_ports { ch2_audio[3] } ]
